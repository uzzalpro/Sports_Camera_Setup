...
# SourcePoints class table definition
class SourcePoints(Base, Point):
    __tablename__ = "source_points"

    # Table columns
    source_point_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    ...
    # Relationships
    # camera: Mapped["Camera"] = relationship(back_populates="source_points")
